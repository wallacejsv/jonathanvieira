	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="content-timeline-timel">
			...
			<?php
				...
				<?php if($thumbPost) : ?>
					<div class="img-post-index">
						<a href="<?php the_permalink(); ?>"><img src="<?php echo $thumbPost; ?>"></a>
					</div>
				<?php endif; ?>
				<?php
			?>
			...
			<?php endif; ?>
				...
				<a href="<?php the_permalink(); ?>" style="font-size:12px;color:#000;text-decoration:none;font-style: initial;"><p>Continue Lendo...</p></a>
